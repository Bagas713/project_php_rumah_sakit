            ...
            <div class="card mb-4">   
              <div class="card-body">
                <?php
                  ...
                  $data = mysqli_query($conn, "SELECT * FROM data_klinis_anus where id_klinis_anus = '$id_klinis'");
                  while($dta = mysqli_fetch_array($data)) {
                    $keluhan = $dta['keluhan'];
                    $period = $dta['period'];
                  ...
                  $title = ['Keluhan', 'Periode', 'Riwayat Keluarga', 'Lokasi', 'Kolonoskopi' , 'CT Scan'];
                  $data = [$keluhan, $period, $famHistory, $lokasi, $kolonoskopi, $ctScan];
            ...
            <div class="card mb-4">   
              <div class="card-body">
                <?php
                  ...
                  $data = mysqli_query($conn, "SELECT * FROM patologi_anus where id_patologi_anus = '$id_patologi'");
                  while($dta = mysqli_fetch_array($data)) {
                    $tumor = $dta['tumor'];
                    $node = $dta['node'];
