            ...
            <div class="card mb-4">   
              <div class="card-body">
                <?php
                  ...
                  $data = mysqli_query($conn, "SELECT * FROM data_klinis_pankreas where id_klinis_pankreas = '$id_klinis'");
                  while($dta = mysqli_fetch_array($data)) {
                    $keluhan = $dta['keluhan'];
                    $period = $dta['period'];
            ...
            <div class="card mb-4">   
              <div class="card-body">
                <?php
                  ...
                  $data = mysqli_query($conn, "SELECT * FROM patologi_pankreas where id_patologi_pankreas = '$id_patologi'");
                  while($dta = mysqli_fetch_array($data)) {
                    $tumor = $dta['tumor'];
                    $node = $dta['node'];
