<?php
  ...
  if($id_klinis_pankreas || $id_klinis) {

    if($id_klinis_pankreas) {
      $query_id = mysqli_query($conn, "SELECT * FROM data_klinis_pankreas WHERE id_klinis_pankreas = '$id_klinis_pankreas'");
      $row = mysqli_fetch_assoc($query_id);
    } else {
      $query_id = mysqli_query($conn, "SELECT * FROM data_klinis_pankreas WHERE id_klinis_pankreas='$id_klinis'");
      $row = mysqli_fetch_assoc($query_id);
    }
...
<div class="container-content">
  <div class="containerTab" style="background:white">
    ...
    } else if($id_klinis_pankreas) {
      echo BASE_URL."module/$type_ill/data-klinis/action.php?type_ill=$type_ill&id_pasien=$id_pasien&id_klinis_pankreas=$id_klinis_pankreas";
    } else {
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          ...
          <?php
              ...
              $data_keluhan = mysqli_query($conn, "SELECT keluhan FROM data_klinis_pankreas WHERE dk_pankreas_id_pasien = '$id_pasien'");
              while ($row = mysqli_fetch_array($data_keluhan)) {
                echo "<option selected value='".$row['keluhan']."'>".$row['keluhan']."</option>";
              }

              $all_keluhan = mysqli_query($conn, "SELECT keluhan FROM data_klinis_pankreas");
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          ...
          <?php
              ...
              $data_fhis = mysqli_query($conn, "SELECT fam_history FROM data_klinis_pankreas WHERE dk_pankreas_id_pasien = '$id_pasien'");
              while ($row = mysqli_fetch_array($data_fhis)) {
                echo "<option selected value='".$row['fam_history']."'>".$row['fam_history']."</option>";
              }

              $all_fhis= mysqli_query($conn, "SELECT fam_history FROM data_klinis_pankreas");
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          ...
          <?php
              ...
              $data_loc = mysqli_query($conn, "SELECT lokasi FROM data_klinis_pankreas WHERE dk_pankreas_id_pasien = '$id_pasien'");
              while ($row = mysqli_fetch_array($data_loc)) {
                echo "<option selected value='".$row['lokasi']."'>".$row['lokasi']."</option>";
              }

              $all_loc = mysqli_query($conn, "SELECT lokasi FROM data_klinis_pankreas");
