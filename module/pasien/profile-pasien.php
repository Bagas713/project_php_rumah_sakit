...
<div class="container-content">
  ...
  <div class="action-home row" style="margin-left: 1px">
    <a href="<?php echo BASE_URL."index.php?page=action/identitas-pasien&id_pasien=$id_pasien&type_ill=$type_ill"; ?>" >
      <button type="button"  class="btn btn-info btn-lg column spc btn-menu"  style="background-color: #0081C9;">
        Identitas Pasien
      </button>
    </a>
    <a href="<?php echo BASE_URL."index.php?page=module/$type_ill/data-klinis/form&id_pasien=$id_pasien&type_ill=$type_ill"; ?>" >
      <button type="button" class="btn btn-info btn-lg column spc btn-menu" style="background-color: #379237;">
        Data Klinis
      </button>
    </a>

    <a href="<?php echo BASE_URL."index.php?page=action/patologi&id_pasien=$id_pasien&type_ill=$type_ill"; ?>" >
      <button type="button" class="btn btn-info btn-lg column spc btn-menu" style="background-color: #FF9F29;">
        Data Potologi
      </button>
    </a>

    <a href="<?php echo BASE_URL."index.php?page=action/data-terapi&id_pasien=$id_pasien&type_ill=$type_ill"; ?>" >
      <button type="button" class="btn btn-info btn-lg column spc btn-menu" style="background-color: #34B3F1;">
        Data Terapi
      </button>
    </a>

    <a href="<?php echo BASE_URL."index.php?page=action/data-survival&id_pasien=$id_pasien&type_ill=$type_ill"; ?>" >
