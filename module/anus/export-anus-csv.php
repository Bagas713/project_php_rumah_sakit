<?php 
  ...
  if($id_klinis && $id_patologi && $id_data_terapi && $id_data_survival) {
    $sql = mysqli_query($conn, "SELECT * FROM data_pasien
                                JOIN data_klinis_anus ON data_pasien.id_pasien = data_klinis_anus.dk_anus_id_pasien
                                JOIN patologi_anus ON data_pasien.id_pasien = patologi_anus.dp_anus_id_pasien
