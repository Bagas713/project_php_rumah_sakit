<?php 
  ...
  if($id_klinis && $id_patologi && $id_data_terapi && $id_data_survival) {
    $sql = mysqli_query($conn, "SELECT * FROM data_pasien
                                JOIN data_klinis_duodenum ON data_pasien.id_pasien = data_klinis_duodenum.dk_duodenum_id_pasien
                                JOIN patologi_duodenum ON data_pasien.id_pasien = patologi_duodenum.dp_duodenum_id_pasien
