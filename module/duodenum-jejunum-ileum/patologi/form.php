      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          ...
          <?php
              ...
              $all_tumor = mysqli_query($conn, "SELECT tumor FROM patologi_duodenum");
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          ...
          <?php
              ...
              $all_node = mysqli_query($conn, "SELECT node FROM patologi_duodenum");
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          ...
          <?php
              ...
              $all_meta = mysqli_query($conn, "SELECT metastasis FROM patologi_duodenum");
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          ...
          <?php
              ...
              $all_locmeta = mysqli_query($conn, "SELECT lokasi_metastasis FROM patologi_duodenum");
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          ...
          <?php
              ...
              $all_jbiop = mysqli_query($conn, "SELECT jenis_patologi_biopsi FROM patologi_duodenum");
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          ...
          <?php
              ...
              $all_jopdef = mysqli_query($conn, "SELECT jenis_patologi_operasi_definitif FROM patologi_duodenum");
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          ...
          <?php
              ...
              $all_grade = mysqli_query($conn, "SELECT grade_histopatologi FROM patologi_duodenum");
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          ...
          <?php
              ...
              $all_reseksi = mysqli_query($conn, "SELECT reseksi FROM patologi_duodenum");
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          ...
          <?php
              ...
              $all_lvi = mysqli_query($conn, "SELECT lvi FROM patologi_duodenum");
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          ...
          <?php
              ...
              $all_inv = mysqli_query($conn, "SELECT invasi_perineural FROM patologi_duodenum");
