<?php 
  ...
  if($id_klinis && $id_patologi && $id_data_terapi && $id_data_survival) {
    $sql = mysqli_query($conn, "SELECT * FROM data_pasien
                                JOIN data_klinis_hepatobilier ON data_pasien.id_pasien = data_klinis_hepatobilier.dk_hepatobilier_id_pasien
                                JOIN patologi_hepatobilier ON data_pasien.id_pasien = patologi_hepatobilier.dp_hepatobilier_id_pasien
