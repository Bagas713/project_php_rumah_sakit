<?php
  ...
  if($id_patologi_esofagus || $id_patologi) {

    if($id_patologi_esofagus) {
      $query_id = mysqli_query($conn, "SELECT * FROM patologi_esofagus WHERE id_patologi_esofagus='$id_patologi_esofagus'");
      $row = mysqli_fetch_assoc($query_id);
    } else {
      $query_id = mysqli_query($conn, "SELECT * FROM patologi_esofagus WHERE id_patologi_esofagus='$id_patologi'");
      $row = mysqli_fetch_assoc($query_id);
    }
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          ...
          <?php
              ...
              $data_tumor = mysqli_query($conn, "SELECT tumor FROM patologi_esofagus WHERE dp_esofagus_id_pasien = '$id_pasien'");
              while ($row = mysqli_fetch_array($data_tumor)) {
                echo "<option selected value='".$row['tumor']."'>".$row['tumor']."</option>";
              }

              $all_tumor = mysqli_query($conn, "SELECT tumor FROM patologi_esofagus");
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          ...
          <?php
              ...
              $data_node = mysqli_query($conn, "SELECT node FROM patologi_esofagus WHERE dp_esofagus_id_pasien = '$id_pasien'");
              while ($row = mysqli_fetch_array($data_node)) {
                echo "<option selected value='".$row['node']."'>".$row['node']."</option>";
              }

              $all_node = mysqli_query($conn, "SELECT node FROM patologi_esofagus");
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          ...
          <?php
              ...
              $data_meta = mysqli_query($conn, "SELECT metastasis FROM patologi_esofagus WHERE dp_esofagus_id_pasien = '$id_pasien'");
              while ($row = mysqli_fetch_array($data_meta)) {
                echo "<option selected value='".$row['metastasis']."'>".$row['metastasis']."</option>";
              }

              $all_meta = mysqli_query($conn, "SELECT metastasis FROM patologi_esofagus");
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          ...
          <?php
              ...
              $data_locmeta = mysqli_query($conn, "SELECT lokasi_metastasis FROM patologi_esofagus WHERE dp_esofagus_id_pasien = '$id_pasien'");
              while ($row = mysqli_fetch_array($data_locmeta)) {
                echo "<option selected value='".$row['lokasi_metastasis']."'>".$row['lokasi_metastasis']."</option>";
              }

              $all_locmeta = mysqli_query($conn, "SELECT lokasi_metastasis FROM patologi_esofagus");
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          ...
          <?php
              ...
              $data_jbiop = mysqli_query($conn, "SELECT jenis_patologi_biopsi FROM patologi_esofagus WHERE dp_esofagus_id_pasien = '$id_pasien'");
              ...
              $all_jbiop = mysqli_query($conn, "SELECT jenis_patologi_biopsi FROM patologi_esofagus");
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          ...
          <?php
              ...
              $data_jopdef = mysqli_query($conn, "SELECT jenis_patologi_operasi_definitif FROM patologi_esofagus WHERE dp_esofagus_id_pasien = '$id_pasien'");
              ...
              $all_jopdef = mysqli_query($conn, "SELECT jenis_patologi_operasi_definitif FROM patologi_esofagus");
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          ...
          <?php
              ...
              $data_grade = mysqli_query($conn, "SELECT grade_histopatologi FROM patologi_esofagus WHERE dp_esofagus_id_pasien = '$id_pasien'");
              while ($row = mysqli_fetch_array($data_grade)) {
                echo "<option selected value='".$row['grade_histopatologi']."'>".$row['grade_histopatologi']."</option>";
              }

              $all_grade = mysqli_query($conn, "SELECT grade_histopatologi FROM patologi_esofagus");
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          ...
          <?php
              ...
              $data_reseksi = mysqli_query($conn, "SELECT reseksi FROM patologi_esofagus WHERE dp_esofagus_id_pasien = '$id_pasien'");
              while ($row = mysqli_fetch_array($data_reseksi)) {
                echo "<option selected value='".$row['reseksi']."'>".$row['reseksi']."</option>";
              }

              $all_reseksi = mysqli_query($conn, "SELECT reseksi FROM patologi_esofagus");
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          ...
          <?php
              ...
              $data_lvi = mysqli_query($conn, "SELECT lvi FROM patologi_esofagus WHERE dp_esofagus_id_pasien = '$id_pasien'");
              while ($row = mysqli_fetch_array($data_lvi)) {
                echo "<option selected value='".$row['lvi']."'>".$row['lvi']."</option>";
              }

              $all_lvi = mysqli_query($conn, "SELECT lvi FROM patologi_esofagus");
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          ...
          <?php
              ...
              $data_inv = mysqli_query($conn, "SELECT invasi_perineural FROM patologi_esofagus WHERE dp_esofagus_id_pasien = '$id_pasien'");
              while ($row = mysqli_fetch_array($data_inv)) {
                echo "<option selected value='".$row['invasi_perineural']."'>".$row['invasi_perineural']."</option>";
              }

              $all_inv = mysqli_query($conn, "SELECT invasi_perineural FROM patologi_esofagus");
