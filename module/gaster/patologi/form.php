      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          ...
          <?php
              ...
              $all_tumor = ["T1a", "T1b", "T2a", "T2b", "T3", "T4a", "T4b"];
...
      </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control" list="all_jbiop" name="jenis_patologi_operasi_definitif" value="<?php echo $jenis_patologi_biopsi; ?>"/>
            <datalist id="all_jbiop">
            <?php
              
              $data_jbiop = mysqli_query($conn, "SELECT jenis_patologi_operasi_definitif FROM patologi_gaster WHERE dp_gaster_id_pasien = '$id_pasien'");
              while ($row = mysqli_fetch_array($data_jbiop)) {
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          ...
          <?php
              ...
              $data_lvi = mysqli_query($conn, "SELECT lvi FROM patologi_gaster WHERE dp_gaster_id_pasien = '$id_pasien'");
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          ...
          <?php
              ...
              $data_inv = mysqli_query($conn, "SELECT invasi_perineural FROM patologi_gaster WHERE dp_gaster_id_pasien = '$id_pasien'");
