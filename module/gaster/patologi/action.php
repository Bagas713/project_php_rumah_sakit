<?php
    ...
    $grade_hitopatologi = $_POST['grade_hitopatologi'];
    ...
    if($button == "Save") {
        mysqli_query($conn, "INSERT INTO patologi_gaster (tumor, node, metastasis, lokasi_metastasis, no_patologi_biopsi, tanggal_biopsi, jenis_patologi_biopsi, no_patologi_operasi_definitif, jenis_patologi_operasi_definitif, grade_hitopatologi, reseksi, batas_reseksi_proksimal, batas_reseksi_distal, lvi, invasi_perineural, catatan_temuan_operasi, dp_gaster_id_pasien, dp_gaster_nama) VALUES ('$tumor', '$node', '$metastasis', '$lokasi_metastasis', '$no_patologi_biopsi', '$tanggal_biopsi', '$jenis_patologi_biopsi' , '$no_patologi_operasi_definitif', '$jenis_patologi_operasi_definitif', '$grade_hitopatologi', '$reseksi', '$batas_reseksi_proksimal', '$batas_reseksi_distal', '$lvi', '$Invansi_perineural', '$catatan_temuan_operasi', '$id_pasien', '$type_ill' )"); 
    ...
    header("location:".BASE_URL."index.php?page=module/$type_ill/data-patologi/form&id_pasien=$id_pasien&type_ill=$type_ill&id_patologi_gaster=$id_patologi_gaster");
?>